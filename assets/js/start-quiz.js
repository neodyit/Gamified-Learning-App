document.addEventListener('DOMContentLoaded', () => {
    ...
    fetch('assets/data/quizzes.json')
        ...
        .then(data => {
            // Find the matching quiz
            const quiz = data.quizzes.find(q => q.subject === subject && q.grades.includes(grade));
        ...
        .catch(error => {
            ...
            quizQuestionsContainer.innerHTML = '<p class="muted text-center">Error loading quiz. Please try again.</p>';
        });

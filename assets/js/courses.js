document.addEventListener('DOMContentLoaded', () => {
    ...
    const coursesData = {
        courses: [
            {
                title: "Mathematics",
                description: "Explore algebra, geometry, and basic calculus tailored for your grade.",
                progress: 75,
                modules: 12,
                enrolled: true,
                rating: 4.8,
            ...
            {
                title: "Science",
                description: "Learn physics, chemistry, and biology concepts for your grade.",
                progress: 60,
                modules: 10,
                enrolled: true,
                rating: 4.7,
            ...
            },
            {
                ...
                description: "Study history, geography, and civics relevant to your grade.",
                progress: 40,
                modules: 15,
                enrolled: true,
                rating: 4.5,
            ...
            {
                title: "English",
                description: "Develop reading, writing, and literature analysis skills.",
                progress: 85,
                modules: 8,
                enrolled: true,
                rating: 4.6,
    ...
    const userGrade = parseInt(userData.grade) || 7; // Default to 7th grade based on image

    const enrolledCoursesContainer = document.getElementById('enrolled-courses');

    // Filter enrolled courses based on user's grade
    const enrolledCourses = coursesData.courses.filter(course => 
        course.enrolled && course.grades.includes(userGrade)
    );

    // Render enrolled courses
    enrolledCoursesContainer.innerHTML = enrolledCourses.length > 0 

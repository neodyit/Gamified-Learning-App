document.addEventListener("DOMContentLoaded", () => {
    ...
    assignments: [
      {
        ...
        description:
          "Solve 10 algebra problems from Chapter 3. Focus on quadratic equations and factoring.",
      ...
      },
      {
        ...
        description:
          "Write a 500-word report on ecosystems. Include diagrams and references.",
      ...
      },
      {
        ...
        description:
          "Write a 300-word essay on 'My Favorite Book'. Include analysis and personal reflection.",
      ...
      },
      {
        ...
        description:
          "Create a timeline of ancient civilizations. Include key events and figures.",
      ...
      },
      {
        ...
        description:
          "Complete review questions for the upcoming algebra test. Focus on weak areas.",
      ...
      },
      {
        ...
        description:
          "Write lab report on Newton's Laws experiment. Include calculations and graphs.",
  ...
  const currentDate = new Date("2025-09-15T10:54:00Z");

  const upcomingAssignmentsContainer = document.getElementById(
    "upcoming-assignments",
  );
  const completedAssignmentsContainer = document.getElementById(
  ...
  const upcoming = userAssignments.filter(
  ...
  if (streakElement)
    streakElement.innerHTML = `<i class="fas fa-tasks"></i> ${pendingCount} Pending`;
  ...
  if (upcoming.length > 0) {
    ...
    upcomingAssignmentsContainer.innerHTML =
      '<p class="muted text-center">Great job! No upcoming assignments.</p>';
  }
  ...
  if (completed.length > 0) {
    ...
    completedAssignmentsContainer.innerHTML =
      '<p class="muted text-center">No completed assignments yet.</p>';
  }
